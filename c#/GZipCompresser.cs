...
namespace System.IO.Compression
{
    ...
    public class GZipCompresser
    {
        ...
        private static byte[] Encode(List<GZipUnit> units)
        {
            ...
            {
                byte[] fn = Encoding.Default.GetBytes(unit.FullFileName);
        ...
        private class GZipUnit
        {
            ...
            public string FileName
            {
                get
                {
                    int startIdx = this._fullFileName.LastIndexOf(Path.DirectorySeparatorChar);
                    return this._fullFileName.Substring(startIdx + 1, this._fullFileName.Length - startIdx - 1);
                }
            }
